...
1. Descarga o clona los archivos del código fuente en una carpeta local.
2. Abre la terminal de comandos (o el Símbolo del Sistema / CMD en Windows).
3. Navega hasta la carpeta donde se encuentran los archivos usando el comando `cd`:
